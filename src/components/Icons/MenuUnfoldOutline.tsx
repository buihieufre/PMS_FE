...
function Base({ path, 'data-icon': dataIcon, ...rest }: IconProps & { path: string }) {
  return (
    <svg
...
export function MenuUnfoldOutlinedIcon(props: IconProps) {
  return <Base path={menuUnfoldPath} data-icon="menu-unfold" {...props} />;
}

export function MenuFoldOutlinedIcon(props: IconProps) {
  return <Base path={menuFoldPath} data-icon="menu-fold" {...props} />;
}
